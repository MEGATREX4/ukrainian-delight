...
public class RecipesRegistry {
    public static final RecipeType<BrewingRecipe> BREWING = RecipeType.register(new UDIdentifier("brewing").toString());
    public static final RecipeSerializer<BrewingRecipe> BREWING_RECIPE_SERIALIZER = new BrewingRecipeSerializer();

    public static void registerRecipes() {

        Registry.register(Registries.RECIPE_SERIALIZER, new UDIdentifier("brewing"), BREWING_RECIPE_SERIALIZER);
